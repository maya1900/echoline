...
const entries: DictionaryEntry[] = [
  ...
  { word: "okay", phonetic: "/ˌoʊˈkeɪ/", translation: "好的；可以；没问题", definition: "Okay, could you, pretty please with sugar on top?" },
  { word: "could", phonetic: "/kʊd/", translation: "能够；可以；可能", definition: "Could you help me?" },
  { word: "pretty", phonetic: "/ˈprɪti/", translation: "漂亮的；相当；颇", definition: "Pretty please with sugar on top." },
  { word: "please", phonetic: "/pliːz/", translation: "请；使高兴", definition: "Pretty please with sugar on top." },
  { word: "sugar", phonetic: "/ˈʃʊɡər/", translation: "糖；甜言蜜语", definition: "Pretty please with sugar on top." },
  { word: "top", phonetic: "/tɑːp/", translation: "顶部；上方；最高处", definition: "With sugar on top." },
