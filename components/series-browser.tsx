          ...
          <article key={item.id} className="overflow-hidden rounded-md border border-[color:var(--line)] bg-[color:var(--panel)]">
            ...
            <div className="p-5">
              <div className="flex flex-wrap gap-2 text-xs font-semibold">
                <span className="rounded bg-[color:var(--ink)] px-2 py-1 text-[color:var(--paper)]">{item.difficulty}</span>
              ...
              <div className="mt-5 flex items-center justify-between gap-4">
                ...
                <Link href={`/learn/${item.episodes[0].id}`} className="flex h-11 shrink-0 items-center gap-2 rounded-md bg-[color:var(--ink)] px-4 text-sm font-semibold text-[color:var(--paper)]">
