...
export function LearningStudio({
  ...
  const lookup = lookupWord ? dictionary.get(lookupWord.toLowerCase()) : undefined;
          ...
          <div className="relative min-h-[300px] bg-[color:var(--ink)] text-white">
            ...
            <div className="relative flex min-h-[300px] flex-col justify-between p-5 sm:p-6">
              ...
              <div className="flex flex-wrap items-center justify-center gap-2">
                ...
                <button onClick={() => setIsPlaying((value) => !value)} className="flex h-11 min-w-32 items-center justify-center gap-2 rounded-md bg-[color:var(--paper)] px-4 font-semibold text-[color:var(--ink)]">
